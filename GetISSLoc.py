...
def get_iss_location():
    ...
    if response.status_code == 200:
        ...
        # Get country based on latitude and longitude
        country = get_country_from_coordinates(latitude, longitude)

        # Display information on the GUI
        display_info(latitude, longitude, timestamp, country)
    ...
    # Schedule the next refresh after 0.5 second
    root.after(2000, get_iss_location)
...
def display_info(latitude, longitude, timestamp, country):
